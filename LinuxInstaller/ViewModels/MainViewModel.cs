...
public partial class MainViewModel : ObservableObject
{
    ...
    public MainViewModel(
        ...
        InstallationFinishViewModel IInstallationFinishViewModel,
    ...
    )
    {
        ...
        routes.Add(new("installationFinish", IInstallationFinishViewModel));
        ...
        _navigationService.CurrentPageIndexObservable
            .Subscribe(async _ =>
            {
                ...
                {
                    await progressViewModel.StartInstallationAsync();
                }
            });
    }
